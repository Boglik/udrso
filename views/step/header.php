...
<head>
    ...
    <meta property="og:description" content="Сайт студенческих отрядов Удмуртской Республики"/>
    ...
    <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
            ...
            if (Yii::$app->user->can('admin')) {
                echo '<li><a href="/admin/news">Админ-панель</a></li>';
            }
            ...
            <li><a href="/plan-meropriyatij">План мероприятия</a></li>
