            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Новости</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">История</a></li>
    ...
    <ul>
        ...
        <li><i class="bx bx-chevron-right"></i> <a href="#">Салон "Жаркий Вован"</a></li>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Партнеры</h4>
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="http://трудкрут.рф">ТРУДКРУТ.РФ</a></li>
