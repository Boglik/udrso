...
?>
 <link rel="stylesheet" href="/assets/css/hk.css">
...
<!--        </li>-->
        ...
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="/uploads/avatars/<?= Yii::$app->user->identity->avatar ?>" class="img-circle" alt="Image" class="user-image img-circle elevation-2" alt="User Image" height="30px">
