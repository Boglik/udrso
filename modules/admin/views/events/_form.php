...
<div class="events-form">
    ...
    <?php
    if($model->start_event) {
        $model->start_event = date("d.m.Y H:i", (integer) $model->start_event);
    }
    echo $form->field($model, 'start_event')->widget(DateTimePicker::className(),[
        'name' => 'start_event',
        'type' => DateTimePicker::TYPE_INPUT,
        'options' => ['placeholder' => 'Ввод начала даты/времени...'],
        'convertFormat' => true,
        'value'=> date("d.m.Y h:i",(integer) $model->start_event),
        'pluginOptions' => [
