...
//            ['status', 'in', 'range' => [self::STAB_MEHAN, self::STAB_UDGU,self::STAB_GGPI, self::STAB_EGIDA, self::BEZ_STABA,]],
            ...
            [['name', 'familia', 'inn', 'snils',
                'mesto_uchebi', 'tip_uchebi', 'nomer_udostoverenia', 'telefon',
                'dolznost','chelina','note','primechanie', 'ustav', 'docs','napr','vznos'], 'string'],
        ];
    }
...
//    }
    ...
    {
        return $this->hasOne(Squad::className(), ['id_user' => 'id']);
    }
}
